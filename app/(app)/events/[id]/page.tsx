    ...
    <div className="min-h-screen bg-ozio-dark pb-20">
      ...
      <div className="px-4 py-6 space-y-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              {event.venues.description && (
                <p className="text-gray-500 text-xs mt-1">{event.venues.description}</p>
              )}
            </div>
            <button
        ...
        <div className="flex gap-3">
          <button className="flex-1 bg-ozio-blue hover:bg-ozio-purple text-white font-bold py-4 px-6 rounded-2xl transition flex items-center justify-center gap-2">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
